...
public class PlateController {
    ...
    @RequestMapping("/getPlateByRedis")
    public void getPlateByRedis(HttpSession session){
        String redis = plateService.getPlateByRedis();
        session.setAttribute("plate_str",redis);
    }
